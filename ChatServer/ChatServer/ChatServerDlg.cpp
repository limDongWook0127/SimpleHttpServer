...
BOOL CChatServerDlg::OnInitDialog()
{
	...
	if (m_ListenSocket.Create(21000, SOCK_STREAM)) //서버 소켓 생성
	{
...
void CChatServerDlg::OnDestroy() //프로그램 전체 종료 직전에 남은 소켓들을 강제 정리하려고, 클라이언트소켓에서도 유사코드 있는데 그땐 클라가 접속 끊었을때 정리하는거임
{
	CDialogEx::OnDestroy();
	POSITION pos;
